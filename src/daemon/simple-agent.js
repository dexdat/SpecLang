      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            error_1 = _a.sent();
            console.error(
              "[SimpleAgent] Failed to parse ".concat(event.path, ":"),
              error_1,
            );
            throw error_1;
          case 4:
          ...
          case 7:
            error_2 = _a.sent();
            console.error(
              "[SimpleAgent] Error processing ".concat(event.path, ":"),
              error_2,
            );
            throw error_2;
          case 8:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              this.generator.generate(spec.id, header, blockData),
            ];
          case 3:
          ...
          case 4:
            error_3 = _b.sent();
            console.error(
              "[SimpleAgent] Failed to generate ".concat(block.id, ":"),
              error_3,
            );
          ...
          case 7:
            ...
            if (errors.length > 0) {
              console.warn(
                "\u26A0\uFE0F  Generated "
                  .concat(generatedFiles.length, " files, ")
                  .concat(errors.length, " failed for ")
                  .concat(spec.id),
              );
              errorMessages = errors
                .map(function (e) {
                  return "".concat(e.blockId, ": ").concat(e.error.message);
                })
                .join(", ");
              throw new Error(
                "Failed to generate "
                  .concat(errors.length, " blocks: ")
                  .concat(errorMessages),
              );
            } else {
              console.log(
                "\u2705 Generated "
                  .concat(generatedFiles.length, " files for ")
                  .concat(spec.id),
              );
            }
            return [3 /*break*/, 9];
          case 8:
            error_4 = _b.sent();
            console.error(
              "[SimpleAgent] Error processing ".concat(filePath, ":"),
              error_4,
            );
            throw error_4;
          case 9:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              (0, promises_1.symlink)(targetPath, srcPath, "junction"),
            ];
          case 6:
            _b.sent();
            return [3 /*break*/, 9];
          case 7:
            error_5 = _b.sent();
            console.log(
              "[SimpleAgent] Symlink failed on Windows, using copy instead",
            );
            // Windows fallback: copy files instead of symlink
            return [
              4 /*yield*/,
              this.copyDirectory(
                "specs/".concat(specSlug, ".spec.dir/src"),
                srcPath,
              ),
            ];
          case 8:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              (0, promises_1.cp)(source, destination, {
                recursive: true,
                force: true,
              }),
            ];
