  ...
  BlockParser.prototype.parseFile = function (filePath) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.validateFilePath(filePath)];
          case 1:
            validatedPath = _a.sent();
            return [
              4 /*yield*/,
              (0, promises_1.readFile)(validatedPath, "utf-8"),
            ];
          case 2:
            content = _a.sent();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              (0, promises_1.realpath)(absolutePath).catch(function () {
                return absolutePath;
              }),
            ];
          case 1:
            ...
            if (
              ...
              throw new poc_1.POCError(
                "PARSE_ERROR",
                'Access denied: Path "'
                  .concat(filePath, '" resolves to "')
                  .concat(
                    realPath,
                    '" which is outside allowed spec directory',
                  ),
                filePath,
              );
            }
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              (0, promises_1.access)(realPath, promises_1.constants.R_OK),
            ];
          case 3:
            _b.sent();
            return [3 /*break*/, 5];
  ...
  BlockParser.prototype.parseBlock = function (match, fullContent, filePath) {
    ...
    if (!(0, poc_1.isValidBlockKind)(rawKind)) {
      throw new poc_1.POCError(
        "PARSE_ERROR",
        'Invalid block kind "'
          .concat(rawKind, '" for block "')
          .concat(id, '". Valid kinds: ')
          .concat(poc_1.VALID_BLOCK_KINDS.join(", ")),
        filePath,
      );
    }
    var kind = rawKind;
  ...
  BlockParser.prototype.parseReturns = function (section) {
    ...
    if (match) {
      return {
        type: match[1],
        description:
          ((_a = match[2]) === null || _a === void 0 ? void 0 : _a.trim()) ||
          "",
      };
    }
    return undefined;
