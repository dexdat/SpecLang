...
describe('System Metrics', () => {
  describe('Memory metrics', () => {
    it('should calculate memory usage percentage', () => {
      const percentage = (mockSystemStats.memory_used_mb / mockSystemStats.memory_total_mb) * 100;
    ...
    it('should identify high memory usage', () => {
      ...
      const usage = (mockSystemStats.memory_used_mb / mockSystemStats.memory_total_mb) * 100;
  ...
  describe('Disk metrics', () => {
    it('should calculate disk usage percentage', () => {
      const percentage = (mockSystemStats.disk_used_gb / mockSystemStats.disk_total_gb) * 100;
      expect(percentage).toBeCloseTo(17.6, 1);
    });
  });

  describe('Health status', () => {
    const getSystemHealth = (cpu: number, memory: number): 'healthy' | 'warning' | 'critical' => {
