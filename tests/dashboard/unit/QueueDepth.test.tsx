...
describe('Queue Depth', () => {
  ...
  describe('Queue depth calculation', () => {
    ...
    it('should filter by action type', () => {
      const generateItems = mockQueueItems.filter(i => i.action === 'generate');
  ...
  describe('Priority handling', () => {
    it('should sort by priority', () => {
      const sorted = [...mockQueueItems].sort((a, b) => a.priority - b.priority);
  ...
  describe('Age tracking', () => {
    ...
    it('should identify stale items', () => {
      ...
      const staleItems = mockQueueItems.filter(i => i.age_seconds > staleThreshold);
