...
const parseSpecPyFile = (..._args: unknown[]) => {
  throw new Error("not implemented");
};
const generateFromSpec = (..._args: unknown[]) => {
  throw new Error("not implemented");
};
const handleSpecPyTrigger = (..._args: unknown[]) => {
  throw new Error("not implemented");
};

const TEST_SPEC_PY_DIR = path.join(
  __dirname,
  "..",
  "..",
  ".speclang",
