...
describe("stdlib: assertions", () => {
  describe("assert", () => {
    ...
    it("should throw with custom message", () => {
      expect(() => assertions.assert(false, "custom error")).toThrow(
        "custom error",
      );
    });
  });
...
describe("stdlib: strings", () => {
  ...
  describe("interpolate", () => {
    it("should interpolate with object properties", () => {
      expect(
        strings.interpolate("{name} is {age}", { name: "John", age: 30 }),
      ).toBe("John is 30");
    });
  });
...
describe("stdlib: collections", () => {
  ...
  describe("filter", () => {
    it("should filter array", () => {
      expect(collections.filter([1, 2, 3, 4], (x) => x % 2 === 0)).toEqual([
        2, 4,
      ]);
    });
  });
  ...
  describe("chunk", () => {
    it("should chunk array", () => {
      expect(collections.chunk([1, 2, 3, 4, 5], 2)).toEqual([
        [1, 2],
        [3, 4],
        [5],
      ]);
  ...
  describe("partition", () => {
    it("should partition by predicate", () => {
      expect(collections.partition([1, 2, 3, 4], (x) => x % 2 === 0)).toEqual([
        [2, 4],
        [1, 3],
      ]);
    });
  ...
  describe("countBy", () => {
    it("should count by key", () => {
      expect(collections.countBy(["a", "b", "a", "c", "a"], (x) => x)).toEqual({
        a: 3,
        b: 1,
        c: 1,
      });
...
describe("stdlib: objects", () => {
  ...
  describe("deepMerge", () => {
    it("should deep merge objects", () => {
      expect(objects.deepMerge({ a: { b: 1 } }, { a: { c: 2 } })).toEqual({
        a: { b: 1, c: 2 },
      });
    });
  });
