...
import {
  ...
  MVP_CRITERIA,
  isMVPLevel,
  createMVPSpecDefaults,
} from "../../src/maturity/levels/mvp";

describe("MVP Level", () => {
  it("should have correct properties", () => {
    expect(MVP_LEVEL.name).toBe("MVP");
    expect(MVP_LEVEL.order).toBe(1);
    expect(MVP_LEVEL.description).toBe(
      "Core functionality validated - Early adopters can use",
    );
    ...
    expect(MVP_LEVEL.requiredFields).toEqual([
      "id",
      "version",
      "tags",
      "short",
