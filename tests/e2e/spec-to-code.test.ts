...
`;
  ...
  describe("Step 3: Generated Code Verification", () => {
    it("should have generated TypeScript file", () => {
      ...
      // SL-GAP-034: parseSpec strips YAML scalar quoting, so the provenance
      // header carries the bare id (@test/simple), not the quoted literal.
...
`;
  ...
  describe("Full Project Initialization Flow", () => {
    ...
    it("should generate code from default spec", () => {
      ...
      execSync(`node ${join(process.cwd(), "bin/speclang")} new my-project`, {
        cwd: TEST_DIR,
        encoding: "utf-8",
        stdio: "pipe",
      });
