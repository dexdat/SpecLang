...
import { AutonomousTestRunner, runAutonomousTests } from '../../src/autonomous/test-runner.js';
...
describe('AutonomousTestRunner', () => {
  ...
  describe('loadTests', () => {
    ...
    it('should include spec_generation test', () => {
      const tests = runner.loadTests();
      const specGenTest = tests.find(t => t.scenario.type === 'spec_generation');
      expect(specGenTest).toBeDefined();
    });
    
    it('should include code_generation test', () => {
      const tests = runner.loadTests();
      const codeGenTest = tests.find(t => t.scenario.type === 'code_generation');
