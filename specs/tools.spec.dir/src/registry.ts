 ...
 */
function validateJSONSchema(schema: JSONSchema, input: any): ValidationResult {
  const errors: string[] = [];
...
export class ToolRegistry {
  ...
  async execute(
    ...
    if (tool.requiresOwnership && this.ownershipChecker) {
      ...
      const ownership = this.ownershipChecker.canWrite(
        context.sessionId,
        context.agentRole,
        filepath
      );
 ...
 */
export function createToolRegistry(ownershipChecker?: OwnershipChecker): ToolRegistry {
