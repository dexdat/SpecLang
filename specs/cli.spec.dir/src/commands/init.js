...
const init_js_1 = require("../../../project-layout.spec.dir/src/init.js");
/**
...
async function initCommand(options) {
    ...
    try {
        const result = await (0, init_js_1.initProject)({
            name,
            targetDir,
            initGit,
            force,
        ...
        console.log((0, init_js_1.formatInitResult)(result, json));
        if (!result.success) {
            process.exit(1);
        }
    }
