...
exports.AUTONOMOUS_SCENARIOS = void 0;
exports.getScenarioByName = getScenarioByName;
exports.getCriticalScenarios = getCriticalScenarios;
exports.getScenariosByType = getScenariosByType;
exports.validateScenarioConfig = validateScenarioConfig;
/**
 * Pre-defined autonomous test scenarios
 */
exports.AUTONOMOUS_SCENARIOS = [
    {
...
function getScenarioByName(name) {
    return exports.AUTONOMOUS_SCENARIOS.find(s => s.name === name);
}
/**
 * Get all critical scenarios
 */
function getCriticalScenarios() {
    return exports.AUTONOMOUS_SCENARIOS.filter(s => s.critical);
}
/**
 * Get scenarios by type
 */
function getScenariosByType(type) {
    return exports.AUTONOMOUS_SCENARIOS.filter(s => s.scenario.type === type);
}
/**
 * Validate that a scenario configuration is valid
 */
function validateScenarioConfig(test) {
    const errors = [];
    if (!test.name) {
