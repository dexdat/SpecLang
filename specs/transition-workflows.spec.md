...
short: Workflows for moving specs between maturity levels
---
# Transition Workflows

Procedures for moving specs between project levels and agent support levels.
...
This spec defines the workflows, checklists, and validation gates
