...
When specs exceed size limits, they split into `.dir/` folders with sub-specs.
...
2. Split content into child specs inside folder
3. Parent becomes index with children refs
4. Children link back to parent

Budget: if limit is 10k, real limit is 10.5k
This covers header overhead and references.

Result: specs expand naturally, never too big.
```
...
DirStructure:
  ...
  parent_as_index:
    header:
      id: @specs/auth/login
      children:
        - @ref:specs/auth/login.spec.dir/01-overview
        - @ref:specs/auth/login.spec.dir/02-entities
        - @ref:specs/auth/login.spec.dir/03-operations
        - @ref:specs/auth/login.spec.dir/04-tests
      short: "Login (split into 4 parts)"
    content: "See parts in login.spec.dir/"
    
  children_link_back:
    header:
      id: @specs/auth/login.spec.dir/01-overview
