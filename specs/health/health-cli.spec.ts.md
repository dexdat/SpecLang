---
id: "@speclang/health/cli"
version: 1.0.0
layer: 1
target_lang: ts
output: specs/health/assembled/health-cli.spec.ts
owned-by: health
depends_on:
  - "@ref:specs/health/health-core"
status: active
tags: [health, cli, dashboard]
---

# Health CLI — Terminal Dashboard

## Overview

Terminal-based health dashboard that displays real-time spec health metrics.
...
```bash
npx tsx specs/health/assembled/health-cli.spec.ts specs/ 5000
```
