---
id: "@speclang/health/test"
version: 1.0.0
layer: 1
target_lang: ts
output: specs/health/assembled/health-test.spec.ts
owned-by: health
status: active
tags: [health, test, verification]
---
...
Integration tests for the health monitor — validates that scanning, analysis, and formatting work.
...
```bash
npx tsx specs/health/assembled/health-test.spec.ts
```
