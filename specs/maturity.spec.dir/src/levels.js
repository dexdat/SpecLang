...
exports.getLevelOrder = getLevelOrder;
...
function getLevelDefinition(level) {
    return exports.MATURITY_LEVELS.find(l => l.name === level);
}
/**
...
function getAllLevels() {
    return exports.MATURITY_LEVELS.map(l => l.name);
}
/**
 * Get level by order
 */
function getLevelByOrder(order) {
    return exports.MATURITY_LEVELS.find(l => l.order === order);
}
/**
