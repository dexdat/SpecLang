...
exports.SpeclangDatabase = void 0;
const better_sqlite3_1 = __importDefault(require("better-sqlite3"));
const promises_1 = require("fs/promises");
const path = __importStar(require("path"));
class SpeclangDatabase {
    db;
    async initialize(path = '.speclang/speclang.db') {
    ...
    async loadMigration(name) {
        ...
        return await (0, promises_1.readFile)(migrationPath, 'utf-8');
    }
}
exports.SpeclangDatabase = SpeclangDatabase;
//# sourceMappingURL=speclang-db.js.map