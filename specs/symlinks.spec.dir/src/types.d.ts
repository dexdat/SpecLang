...
export type SymlinkErrorCode = 'TARGET_NOT_FOUND' | 'PERMISSION_DENIED' | 'ALREADY_EXISTS' | 'INVALID_PATH' | 'BROKEN_SYMLINK' | 'PLATFORM_UNSUPPORTED';
...
export declare function getPlatformConfig(): SymlinkPlatform;
/** Default paths for dual-view system */
export declare const DEFAULT_DUAL_VIEW_CONFIG: DualView;
/** Default git config for symlinks */
export declare const DEFAULT_GIT_SYMLINKS_CONFIG: GitSymlinksConfig;
