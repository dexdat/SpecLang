...
CompletenessScoring:
  ...
  layer_based_requirements:
    layer_0_1: "No downstream requirements"
    layer_2_3: "Should have at least one child spec"
    layer_4_5: "Must have corresponding code spec (.go.spec, .ts.spec, etc.)"
    layer_6_7: "Must have implementation spec and test spec"
    layer_8_10: "Must have deployment and monitoring specs"
