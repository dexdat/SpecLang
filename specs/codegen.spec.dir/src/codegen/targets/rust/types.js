...
exports.RUST_TYPE_MAPPINGS = void 0;
exports.resolveRustType = resolveRustType;
exports.resolveGenericType = resolveGeneric;
exports.RUST_TYPE_MAPPINGS = [
    // Primitives - Basic
...
function lookupMapping(stdlibType) {
    return exports.RUST_TYPE_MAPPINGS.find(m => m.stdlib === stdlibType);
}
function resolveRustType(stdlibType) {
