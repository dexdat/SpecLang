...
class TypeScriptGenerator {
    ...
    generateInterface(_spec, block) {
        const template = (0, templates_1.getTemplate)('typescript', 'interface');
        if (!template)
    ...
    generateFunction(_spec, block) {
        const template = (0, templates_1.getTemplate)('typescript', 'function');
        if (!template)
            return block.content;
    ...
    generateClass(_spec, block) {
        const template = (0, templates_1.getTemplate)('typescript', 'class');
        if (!template)
            return block.content;
    ...
    generateType(_spec, block) {
        const template = (0, templates_1.getTemplate)('typescript', 'type');
        if (!template)
            return block.content;
    ...
    mapType(stdlibType) {
        return (0, mapper_1.mapType)(stdlibType, 'typescript');
    }
    ...
    fileHeader(spec) {
        return (0, templates_1.createFileHeader)(spec, 'speclang-typescript-generator');
    }
